...
const SoundEffect = ({ children, className, delay = 0 }) => (
  <motion.div
    ...
    className={`absolute z-30 font-bangers text-4xl md:text-6xl tracking-widest italic drop-shadow-[4px_4px_0_#161616] pointer-events-none ${className}`}
  >
    {children}
  </motion.div>
);
...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-gray-50 text-comicBlack">
      <div className="max-w-7xl mx-auto p-4 md:p-8 flex flex-col gap-16 pt-12">
        ...
        >
          {/* Profile Card */}
          <div className="md:col-span-1 bg-comicYellow border-8 border-comicBlack shadow-[12px_12px_0_#161616] p-8 flex flex-col items-center gap-6 relative overflow-hidden">
            <div className="absolute inset-0 opacity-[0.06] pointer-events-none" style={{
              backgroundImage: 'repeating-linear-gradient(45deg, #161616 0, #161616 1px, transparent 0, transparent 50%)',
              backgroundSize: '10px 10px',
            }}></div>
            <div className="w-40 h-40 bg-comicBlack border-[6px] border-comicBlack rounded-full shadow-[6px_6px_0px_#161616] overflow-hidden relative">
            ...
            <div className="bg-comicBlack text-white px-4 py-2 font-bangers text-xl tracking-widest transform -rotate-2 shadow-[4px_4px_0_#FF2E2E]">
              AGENT DOSSIER
            </div>
            <p className="font-comic font-bold text-sm text-center leading-snug text-comicBlack relative z-10">
          ...
          <div className="md:col-span-2 flex flex-col gap-6">
            <div className="bg-white border-8 border-comicBlack shadow-[8px_8px_0_#161616] p-8">
              <h2 className="font-bangers text-4xl text-comicRed tracking-widest mb-4" style={{ textShadow: '3px 3px 0px #161616' }}>
                SECRET IDENTITY
              </h2>
              <p className="font-bangers text-2xl text-comicBlue mb-3 uppercase italic tracking-tighter">&quot;The Code-Squashing Avenger&quot;</p>
              <p className="font-comic font-bold text-lg leading-relaxed">
            ...
            {/* Powers Section */}
            <div className="bg-white border-8 border-comicBlack shadow-[8px_8px_0_#161616] p-8">
              <h3 className="font-bangers text-3xl text-comicRed tracking-widest mb-6">POWERS &amp; ABILITIES</h3>
              
              {/* DSA Power Bar */}
              <div className="bg-comicYellow border-4 border-comicBlack p-5 shadow-[4px_4px_0px_#161616] transform rotate-[-1deg] mb-6">
                <div className="flex justify-between items-center mb-3">
                  <span className="font-bangers text-xl text-comicBlack">ALGORITHMIC MASTERY</span>
                  <span className="bg-comicBlack text-white px-3 py-1 font-bangers text-lg">150+</span>
                </div>
                <div className="w-full bg-white h-5 border-4 border-comicBlack relative overflow-hidden">
                  <motion.div 
                ...
                <p className="font-comic font-bold text-xs mt-2 text-comicBlack/70 uppercase tracking-widest">LeetCode Challenges Crushed</p>
              </div>
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['LLMs', 'TensorFlow', 'Neural Nets', 'LangChain'].map(tech => (
                      <span key={tech} className="px-3 py-1 border-2 border-comicBlack font-comic font-bold text-xs uppercase bg-gray-100">{tech}</span>
                    ))}
                  </div>
                </div>
                <div className="flex flex-col gap-3">
        ...
        <div className="relative">
          <div className="text-center mb-16 px-4">
            <motion.h2 
              className="font-bangers text-5xl md:text-8xl tracking-widest inline-block relative rotate-[-1deg]" 
              style={{ textShadow: '6px 6px 0 #0070bc' }}
              {...springPop(0.2)}
            >
              BEYOND THE CODE
            </motion.h2>
            <div className="mt-4 flex flex-col items-center">
              <motion.span 
                className="bg-comicYellow text-comicBlack font-bangers px-6 py-2 text-xl md:text-3xl tracking-widest transform rotate-1 shadow-[4px_4px_0_#161616]"
                {...springPop(0.4)}
              >
                THE LEGEND BEGINS!
              </motion.span>
              <p className="font-comic font-bold text-sm md:text-lg mt-6 text-comicBlue uppercase tracking-widest max-w-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 max-w-5xl mx-auto p-4 md:p-12 bg-white border-[12px] border-comicBlack shadow-[20px_20px_0_#161616] relative overflow-hidden">
            {/* Background Texture */}
            ...
            <div className="md:col-span-7 h-[400px] relative">
              ...
              <SoundEffect className="top-1/4 left-1/4 text-comicBlack" delay={0.2}>BZZZT!!</SoundEffect>
            </div>
            ...
            <div className="md:col-span-5 h-[400px] relative">
              ...
              <SoundEffect className="top-8 right-8 text-comicBlack opacity-40 text-2xl" delay={0.4}>TIC... TOC...</SoundEffect>
            </div>
            ...
            <div className="md:col-span-4 h-[350px] relative">
              ...
              <SoundEffect className="bottom-12 right-4 text-comicBlack text-5xl" delay={0.6}>BEEP-BEEP!</SoundEffect>
            </div>
            ...
            <div className="md:col-span-8 h-[350px] relative">
              ...
              <SoundEffect className="bottom-4 right-12 text-comicBlack text-7xl" delay={0.8}>KAPOW!!</SoundEffect>
            </div>
            ...
            <div className="md:col-span-12 h-[300px] relative">
              ...
              <SoundEffect className="bottom-8 left-8 text-comicBlack" delay={1.0}>YATTA!!</SoundEffect>
            </div>
          </div>
          ...
          <div className="mt-16 flex justify-center">
            <motion.div
              className="bg-comicBlack text-white font-comic font-bold text-base md:text-xl px-10 py-6 border-8 border-comicYellow shadow-[8px_8px_0_#FFC82C] max-w-3xl text-center leading-relaxed italic transform rotate-[-1deg]"
